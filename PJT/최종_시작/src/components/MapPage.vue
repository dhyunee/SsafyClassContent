<template>
  <div class="container-map">
    <div
      class="container-fluid bg-primary mb-4 wow fadeIn"
      data-wow-delay="0.1s"
      style="padding: 25px"
    >
      <div class="container">
    ...
    <div class="mt-2 row no-gutters">
      <div class="col-3 md-4 mb-4">
        <!-- Exaple 1 -->
        <div class="card example-1 square scrollbar-dusty-grass square thin">
          <div class="card-body">
            <div v-for="apt in sel_apt" :key="apt.aptCode">
              <h4 id="section1">
...
export default {
  data() {
    return {
      ...
      sel_dong: ["동"],
      sel_apt: [
        { aptCode: "11110000000001", apartmentName: "아이파크" },
        { aptCode: "21110000000002", apartmentName: "더샵" },
        { aptCode: "31110000000003", apartmentName: "래미안" },
        { aptCode: "41110000000004", apartmentName: "자이" },
        { aptCode: "51110000000005", apartmentName: "아크로" },
      ],
      locations: [],
      selection: 1,
      images: {
